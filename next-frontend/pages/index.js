    ...
    <><>
      ...
      <div className="hidden absolute right-0 min-h-screen w-2/3 bg-primary py-4 px-8 shadow md:w-1/3">
        <button className="absolute top-0 right-0 mt-4 mr-4">
          <Image src="/assets/img/icon-close.svg" className="h-10 w-auto" alt="" />
        </button>
        ...
        <div className="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
          <div className="flex flex-col items-center justify-center lg:flex-row">
            ...
            <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              <h1 className="text-center font-header text-4xl text-white sm:text-left sm:text-5xl md:text-6xl">Hello I am {profile.name}</h1>
      ...
      <div className="bg-grey-50" id="about">
        <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
          <div className="w-full text-center">
            ...
            <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">I am Kamal Anand, a Web developer, ML enthusiast and competitive programmer</h4>
            <p className="pt-6 font-body leading-relaxed text-grey-20">I am pursuing Bachelor of Technology in Computer Science and Engineering, at IIT (ISM) Dhanbad. I am also pursuing a minor degree in Finance. About my technical skills, the programming languages which I have learnt are C, C++ and python. I have also explored web development projects involving Mern Stack and sanity based projects. Apart from this, I have done projects involving machine learning. I have regularly participated in online coding contests across different platforms. I have covered courses like object oriented programming  and data, structures and algorithms. I have been among the high grade achievers in the college. My hobby is singing and I also love playing chess.</p>
            <div className="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
              ...
              <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                <Link href="https://twitter.com/Kamal_anand0/" className="pl-4">
                  <i className="bx bxl-twitter text-2xl text-primary hover:text-yellow"></i>
                </Link>
                <Link href="https://www.linkedin.com/in/kamal-anand-935901227/" className="pl-4">
                  <i className="bx bxl-linkedin text-2xl text-primary hover:text-yellow"></i>
                </Link>
                <Link href="https://www.instagram.com/kamal3.8/" className="pl-4">
      ...
      <div className="container py-16 md:py-20" id="skills">
        <h2 className="text-center font-header text-4xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl">Here is what I am good at</h2>
        <h3 className="pt-6 text-center font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">These are my technical skills</h3>
...
PHP, Laravel, Sanity
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                <Image src="/assets/img/icon-mobile-white.svg" alt="Mobile Application icon" />
              </div>
              <div className="block group-hover:hidden">
                <Image src="/assets/img/icon-mobile-black.svg" alt="Mobile Application icon" />
              </div>
            </div>
            <div className="text-center">
              <h3 className="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
...
API
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                <Image src="/assets/img/icon-email-white.svg" alt="Email Marketing icon" />
              </div>
              <div className="block group-hover:hidden">
                <Image src="/assets/img/icon-email-black.svg" alt="Email Marketing icon" />
              </div>
            </div>
            <div className="text-center">
              <h3 className="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                <Image src="/assets/img/icon-design-white.svg" alt="Theme Design icon" />
              </div>
              <div className="block group-hover:hidden">
                <Image src="/assets/img/icon-design-black.svg" alt="Theme Design icon" />
              </div>
            </div>
            <div className="text-center">
              <h3 className="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
...
Economics & Finance
      ...
      <div className="container py-16 md:py-20" id="portfolio">
        <h2 className="text-center font-header text-4xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl">Check out my Projects</h2>
        <h3 className="pt-6 text-center font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">Here is what I have done with the past</h3>

        <div className="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
          <Link href="https://asmeiitdhanbad.vercel.app/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <Image src="/assets/img/Screenshot 2023-12-18 154308.png" className="w-full shadow" alt="portfolio image" />
          </Link> <p className="pt-1 font-body leading-relaxed text-grey-20 sm:text-xl lg:text-2xl">
  <span>
  ...
  <span>
    <br />❖ Tech Stack: HTML, CSS, JavaScript, Next JS, GROQ and Sanity.
          ...
          <Link href="https://ism-connect-example.onrender.com/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <Image src="/assets/img/Screenshot 2023-12-18 154503.png" className="w-full shadow" alt="portfolio image" />
          </Link>
  ...
  <span>
    <br />❖ Tech Stack: HTML, CSS, PHP, Laravel, MySQL.
          ...
          <Link href="https://github.com/kamal030803/Workout-Website-MERN" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <Image src="/assets/img/Screenshot 2023-12-18 154310.png" className="w-full shadow" alt="portfolio image" />
          </Link>
          <p className="pt-1 font-body leading-relaxed text-grey-20 sm:text-xl lg:text-2xl">
          ...
          <Link href="https://kamal030803.github.io/WeatherBlaze/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <Image src="/assets/img/Screenshot 2023-12-18 154414.png" className="w-full shadow" alt="portfolio image" />
          </Link>
...
information </span>
      ...
      <div className="container py-16 md:py-20" id="education">
        ...
        <h3 className="pt-6 text-center font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
          Here is how my education background looks
        </h3>
        ...
        <div className="relative mx-auto mt-12 flex w-full flex-col lg:w-2/3">
            ...
            <div className="md:w-2/5">
              <div className="flex justify-center md:justify-start">
                <span className="shrink-0">
                  <Image src="/assets/img/temp1.svg" className="h-auto w-32" alt="company logo" />
                </span>
          ...
          <div className="mt-8 flex flex-col text-center md:flex-row md:text-left">
            <div className="md:w-2/5">
              <div className="flex justify-center md:justify-start">
                <span className="shrink-0">
                  <Image src="/assets/img/temp2.svg" className="h-auto w-32" alt="company logo" />
                </span>
                <div className="relative ml-3 hidden w-full md:block">
                  <span className="absolute inset-x-0 top-1/2 h-0.5 -translate-y-1/2 transform bg-grey-70"></span>
                </div>
              ...
              <div className="relative flex md:pl-18">
                ...
                <div className="mt-1 flex">
                  ...
                  <div className="md:-mt-1 md:pl-8">
                    ...
                    <span className="block pt-2 font-header text-xl font-bold text-primary">Bachelor of Technology</span>
                    <div className="pt-2">
